...
def init_command(config_path: Path | None = None) -> None:
    ...
    print()
    print("Next steps:")
    print("  1. Add repositories: gh-worker add owner/repo")
    print("  2. Sync issues: gh-worker sync --all-repos")
    print("  3. Generate plans: gh-worker plan --all-repos")
    print("  4. Implement: gh-worker implement --all-repos")
